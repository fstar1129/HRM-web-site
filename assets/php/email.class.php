<?php
/**
 * Email class to setup and send text and HTML emails
 *
 * @author Geoff Ryan <geoffreyjr@gmail.com>
 */
 ...
 *
 *   from					   - who the email is from - ie. the sender
 *   to						   - Mandatory (if cc and bcc are blank) - the recipient of the email
 *   cc						   - Mandatory (if to and bcc are blank) - the carbon copy recipient of the email
 *   bcc					   - Mandatory (if to and cc are blank) - the blind carbon copy recipient of the email
 *   subject				   - The description of the email that goes in the Subject line
 *   message				   - The content of the email
 *
 * Results:
 *   The email is sent successfully!  Or failed!
 *
 */
